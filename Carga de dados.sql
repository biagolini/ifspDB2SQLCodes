...
-- tblCustomer
-- -----------------------------------------------------
INSERT INTO GameStore.tblCustomer(dsFirstName,dsLastName,dsEmail,dsBirthDate,dsCPF,dsStreet,dsNumber,dsCity,idTypeState,dsZip) VALUES
...
('Helena', 'helena@email.com', '$2a$10$WXfQsblcdtTpL/dndZUC9.NUXDk6bvOTpCr33N7E2/cB/U83RTfvu',3,2);
SELECT * FROM tblUser;
